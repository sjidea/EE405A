...
class WaypointFollower():
    ...
    # Controller
    def steer_control(self, error_y, error_yaw, ierror_y, ierror_yaw):
        """
        Steering control
        ...
        """
        kp_y   = 0.1 # P gain w.r.t. cross track error
        kp_yaw = 0.1 # P gain w.r.t. yaw error

	ki_y = 0.05
	ki_yaw = 0.05
        
        steer = kp_y*error_y + kp_yaw*error_yaw + ki_y*ierror_y + ki_yaw*ierror_yaw
...
def main():
	...
	ierror_y = ierror_y + error_y;
        ierror_yaw = ierror_yaw + error_yaw;

        # Control
        steer_cmd = wpt_control.steer_control(error_y, error_yaw, ierror_y, ierror_yaw)
